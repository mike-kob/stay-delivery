...
import {Button, Col, Form, FormGroup, Navbar, NavLink} from "react-bootstrap";
import {clientGraphql} from '@/graphql';
import {UPDATE_RESTAURANT_MUTATION, GET_RESTAURANT_QUERY} from '@/graphql/rastaurant';
...
const Account = () => {
    ...
    useEffect(() => {
        (async function() {
            ...
            console.log(data.me.restaurant.name)
        ...
        <div className={styles.main}>
            ...
            <div className={styles.form_area}>
                <div className="row justify-content-center">
                    ...
                    <Col xs={6}>
                        <p style={{fontFamily:"Krona One", fontSize: "18px"}}>General information</p>
                        <Form>
                        ...
                        <Button type="submit" className={styles.orng_button} onClick={onSubmit}>
                            Update data
                        </Button>
